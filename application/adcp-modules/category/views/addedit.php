...
<div class="form-group has-warning">
  <label class="control-label" for="inputWarning1">Nhập Tên Loại Hàng</label>
  <input type="text" class="form-control" name="name" placeholder="Nhập name ...." value="<?php echo @$detail[0]->name;  ?>" >
</div>

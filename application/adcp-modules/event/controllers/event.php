...
class event extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->model = $this->load->model('Models_event'); 
         $this->modelcthd = $this->load->model('order_detail/Models_event'); 
    ...
    public function index(){ 
        ...
        $where['tbl_event.status !='] = 2;
        
        $select = 'tbl_event.*';
        
	$data['list'] = $this->model->getList($where , FALSE , FALSE , FALSE ,  $select);  

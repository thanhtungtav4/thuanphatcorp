...
<div class="row">
    ...
    <div class="box-inner">
       <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Nhà Mẫu</h2>
...
<script type="text/javascript" src="<?php echo $this->config->item('static_path'); ?>themes/admin/scripts/jquery.tinymce.js"></script>
 ...
 <table class="table table-striped table-bordered bootstrap-datatable ">
  ...
  <label class="control-label" for="inputSuccess1">Tên Danh Mục (kích vào chon nhà mẫu)</label>
    <br>
    <select name="cat_id"> 
        <?php
    ...
    <!--   <div class="form-group has-success">
  <label class="control-label" for="inputSuccess1">Nhập Số 2 để tin này không bị bay vào mục dự án . Anh chị thông cảm , tại lười code nên làm tạm</label>
  <input type="text" class="form-control" name="tintuc" placeholder="tintuc" value="<?php echo @$detail[0]->tintuc;  ?>">
</div> -->
       <div class="form-group has-success">
  <label class="control-label" for="inputSuccess1">Tên Nhà Mẫu</label>
  <input type="text" class="form-control" name="name" placeholder="name" value="<?php echo @$detail[0]->name;  ?>">
</div>

 <!--<div class="form-group has-success">
  <label class="control-label" for="inputSuccess1">Nhập tiêu đề</label>
  <input type="text" class="form-control" name="tittle" placeholder="tiêu đề" value="<?php echo @$detail[0]->tittle;  ?>">
</div>


<div class="form-group has-warning">
  <label class="control-label" for="inputWarning1">Nhập Mô Tả Ngắn</label><br>
 <textarea class="input" name="description"  style="width: 100%" rows="10"><?php echo @$detail[0]->description;  ?></textarea></div>

 <div class="form-group has-warning">
  <label class="control-label" for="inputWarning1">Nhập Nội Dụng Tin Tức</label><br>

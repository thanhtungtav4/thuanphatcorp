...
class products extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->model = $this->load->model('Models_products'); 
         $this->modelcthd = $this->load->model('order_detail/Models_products'); 
